...
/*
const ACTIVITIES = [
  { name: "Scuba Diving", location: "Goa", price: "₹3,200", duration: "2h" },
  { name: "Hot Air Balloon", location: "Jaipur", price: "₹8,500", duration: "1h" },
  { name: "Trekking", location: "Manali", price: "₹1,800", duration: "4h" },
];
*/
  ...
  return (
    <PortalShell portalName="Traveler" portalColor="#1677FF" portalBg="#EFF6FF" portalIcon={User} navItems={NAV} userName={displayName} userRole="Traveler">
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45 }}
        ...
        <h1 style={{ fontSize: 26, fontWeight: 900, marginBottom: 8 }}>Activity Booking</h1>
        <p style={{ fontSize: 13, opacity: 0.72 }}>Book adventure activities, guided city tours, and local experiences.</p>
      </motion.div>
      ...
      <Card style={{ padding: 60, textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
        ...
        <p style={{ fontSize: 14, color: "#6b7280", maxWidth: 440, lineHeight: 1.6 }}>
          Local guides, adventure operators, and attraction ticketing platforms are being integrated. Real-time booking of activities will be live shortly!
        </p>
      </Card>
    </PortalShell>
  );
