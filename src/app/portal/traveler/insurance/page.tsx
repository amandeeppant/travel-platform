...
/*
const POLICIES = [
  { name: "Trip Cancellation", coverage: "Up to ₹50,000" },
  { name: "Medical Emergencies", coverage: "Up to ₹1,00,000" },
  { name: "Lost Luggage", coverage: "Up to ₹10,000" },
];
*/
  ...
  return (
    <PortalShell portalName="Traveler" portalColor="#1677FF" portalBg="#EFF6FF" portalIcon={User} navItems={NAV} userName={displayName} userRole="Traveler">
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45 }}
        ...
        <h1 style={{ fontSize: 26, fontWeight: 900, marginBottom: 8 }}>Travel Insurance</h1>
        <p style={{ fontSize: 13, opacity: 0.72 }}>Protect your trip with trusted travel insurance plans.</p>
      </motion.div>
      ...
      <Card style={{ padding: 60, textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
        ...
        <p style={{ fontSize: 14, color: "#6b7280", maxWidth: 440, lineHeight: 1.6 }}>
          We are partnering with leading insurance providers to bring you comprehensive health, luggage, and cancellation policies at low premiums. Coming soon!
        </p>
      </Card>
    </PortalShell>
  );
