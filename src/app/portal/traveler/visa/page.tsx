...
/*
const VISA_OPTIONS = [
  { country: "Canada", type: "Tourist Visa", duration: "6 months", fee: "₹8,000" },
  { country: "Australia", type: "Visitor Visa", duration: "12 months", fee: "₹12,500" },
  { country: "Singapore", type: "E-Visa", duration: "30 days", fee: "₹4,200" },
];
*/
  ...
  return (
    <PortalShell portalName="Traveler" portalColor="#1677FF" portalBg="#EFF6FF" portalIcon={User} navItems={NAV} userName={displayName} userRole="Traveler">
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.45 }}
        ...
        <h1 style={{ fontSize: 26, fontWeight: 900, marginBottom: 8 }}>Visa Assistance</h1>
        <p style={{ fontSize: 13, opacity: 0.72 }}>Get visa support and application guidance for top travel destinations.</p>
      </motion.div>
      ...
      <Card style={{ padding: 60, textAlign: "center", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center" }}>
        ...
        <p style={{ fontSize: 14, color: "#6b7280", maxWidth: 440, lineHeight: 1.6 }}>
          Our visa concierge desk and automated document validation agent are currently being prepared to streamline your visa processing. Stay tuned!
        </p>
      </Card>
    </PortalShell>
  );
